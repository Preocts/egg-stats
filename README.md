...
[![pre-commit.ci status](https://results.pre-commit.ci/badge/github/Preocts/egg-stats/main.svg)](https://results.pre-commit.ci/latest/github/Preocts/egg-stats/main)
[![Python tests](https://github.com/Preocts/egg-stats/actions/workflows/python-tests.yml/badge.svg?branch=main)](https://github.com/Preocts/egg-stats/actions/workflows/python-tests.yml)
...
```console
$ git clone https://github.com/Preocts/egg-stats
$ cd egg-stats
```
